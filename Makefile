...
pkgdatadir = $(datadir)/iplog
pkglibdir = $(libdir)/iplog
pkgincludedir = $(includedir)/iplog
...
LIBS =  -lpthread -lpcap 
MAINT = #
MAKEINFO = /usr/src/iplog-2.2.3/missing makeinfo
PACKAGE = iplog
VERSION = 2.2.3

SUBDIRS = src
man_MANS = iplog.8 iplog.conf.5
EXTRA_DIST = iplog.8 iplog.conf.5
